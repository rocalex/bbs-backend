...
ActiveRecord::Schema.define(version: 20_210_624_195_232) do
  ...
  create_table 'spree_adjustments', force: :cascade do |t|
    ...
    t.index %w[adjustable_id adjustable_type], name: 'index_spree_adjustments_on_adjustable_id_and_adjustable_type'
  ...
  create_table 'spree_calculators', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6
    t.text 'preferences'
    t.index %w[calculable_id calculable_type], name: 'index_spree_calculators_on_calculable_id_and_calculable_type'
  ...
  create_table 'spree_option_values_variants', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6
    t.datetime 'updated_at', precision: 6
    t.index %w[variant_id option_value_id], name: 'index_option_values_variants_on_variant_id_and_option_value_id'
  ...
  create_table 'spree_roles_users', force: :cascade do |t|
    ...
    t.index %w[user_id role_id], name: 'index_spree_roles_users_on_user_id_and_role_id', unique: true
  ...
  create_table 'spree_state_changes', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6
    t.datetime 'updated_at', precision: 6
    t.index %w[stateful_id stateful_type], name: 'index_spree_state_changes_on_stateful_id_and_stateful_type'
  ...
  create_table 'spree_stock_items', force: :cascade do |t|
    ...
    t.index %w[variant_id stock_location_id], name: 'index_spree_stock_items_on_variant_id_and_stock_location_id',
  ...
  create_table 'spree_zone_members', force: :cascade do |t|
    ...
    t.index %w[zoneable_id zoneable_type], name: 'index_spree_zone_members_on_zoneable_id_and_zoneable_type'
  end
